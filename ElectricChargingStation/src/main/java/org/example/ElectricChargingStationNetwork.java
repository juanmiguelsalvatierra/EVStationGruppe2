...
public class ElectricChargingStationNetwork {
    public static void main(String[] args) {
        ...
        //US2.3 Withdraw balance
        System.out.println("---------Withdraw balance--------");
        System.out.println("---------Hansis old balance---------");
        System.out.println(customerManager.customerRepo.get(1).getBalance());
        System.out.println("---------Hansis withdraws 10.50€---------");
        customerManager.customerRepo.get(1).withdraw(10.50, LocalDateTime.now());
        System.out.println("---------Hansis new balance---------");
        System.out.println(customerManager.customerRepo.get(1).getBalance());
    }
}
